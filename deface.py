...
imagelink = raw_input("image link (middle): ")
bgimage = raw_input("image link (background): ")
message = raw_input("Message. use the <br> code for the next text! : ")
textcolor = raw_input("Text color (example=green): ")
...
print "Contact : instagram.com/s1_z3us"
